...
EMPLOYMENT_OPTIONS = ["Full-time", "Part-time", "Internship", "Remote", "Hybrid", "Contract"]


# ---------- Sidebar navigation ----------
def sidebar_nav():
    #st.sidebar.title("🧠 CV Screener")
    st.sidebar.markdown( '<h1 style="font-size: 40px;"> CV Scanner </h1>', unsafe_allow_html=True)
    st.sidebar.markdown("---")
